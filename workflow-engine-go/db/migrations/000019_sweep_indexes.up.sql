...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cases_expiry_sweep
ON cases (status, created_at)
WHERE status IN ('OPEN', 'IN_PROGRESS');

-- Archival sweep: find completed/cancelled cases past archive TTL
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cases_archival_sweep
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tasks_sla_sweep
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tasks_breach_candidates
